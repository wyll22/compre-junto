    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-8 w-full">
        ...
        <div className="prose prose-sm max-w-none space-y-4 text-foreground/90">
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-foreground">2. Prazos de Entrega</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-foreground">3. Frete</h2>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-foreground">4. Acompanhamento</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-foreground">5. Tentativas de Entrega</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-foreground">6. Problemas na Entrega</h2>
