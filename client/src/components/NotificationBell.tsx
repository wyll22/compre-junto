  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 bg-destructive text-destructive-foreground text-[10px] font-bold rounded-full w-[18px] h-[18px] flex items-center justify-center min-w-[18px] px-1">
                ...
                <div>
                  {notifications.map((n) => {
                    const href =
                      n.targetPath ||
                      (n.referenceId
                        ? `/minha-conta?tab=orders&orderId=${n.referenceId}`
                        : "/notificacoes");
