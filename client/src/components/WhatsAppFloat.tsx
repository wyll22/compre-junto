...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(env(safe-area-inset-bottom)+3.8rem)] right-3 z-[9998] flex h-[54px] w-[54px] items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_28px_rgba(2,6,23,0.2)] transition-transform duration-200 hover:scale-105 sm:right-4 sm:h-[58px] sm:w-[58px]"
