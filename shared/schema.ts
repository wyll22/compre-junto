...
export const pickupPoints = pgTable("pickup_points", {
  ...
  openingTime: text("opening_time").default(""),
  closingTime: text("closing_time").default(""),
  lunchStart: text("lunch_start").default(""),
  lunchEnd: text("lunch_end").default(""),
  unavailableDays: text("unavailable_days").default(""),
...
export const createPickupPointSchema = z.object({
  ...
  manager: z.string().max(150).optional().default(""),
  pickupInstructions: z.string().max(2000).optional().default(""),
  workingDays: z.string().max(300).optional().default(""),
  openingTime: z.string().max(20).optional().default(""),
  closingTime: z.string().max(20).optional().default(""),
  lunchStart: z.string().max(20).optional().default(""),
  lunchEnd: z.string().max(20).optional().default(""),
  unavailableDays: z.string().max(500).optional().default(""),
